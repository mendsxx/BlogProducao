...
const Footer = (props) => (
    <footer id="footer" style={props.timeout ? { display: 'none' } : {}}>
        ...
        <p className="copyright">&copy; Icones: <a href="https://icon-icons.com/">icons-icons</a> by: <a href="https://github.com/robertohuertasm">Roberto Huertas</a> | John Gardner | <a href="https://www.iconfinder.com/adamwatson">Adam Watson</a> | <a href="https://www.iconfinder.com/justui">Just UI</a></p>
    </footer>
)
